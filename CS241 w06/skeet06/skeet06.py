...
class Bullet(FlyingObject):
    ...
    def fire(self, angle):
        self.angle = angle
        self.velocity.x = math.cos(math.radians(self.angle))
        self.velocity.y = math.sin(math.radians(self.angle))
...
class Target(FlyingObject):
    def __init__(self):
        ...
        self.velocity.velocity_x = random.uniform(1, 5)
        self.velocity.velocity_y = random.uniform(-2, 5)
